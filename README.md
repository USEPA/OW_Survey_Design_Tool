# Survey Design Tool
*Current version: 2.0.0 Last updated: 3/5/2024
## How to Launch the Tool
* Visit rconnect-public.epa.gov/survey-design-tool to launch the tool from EPA's Office of Water Shiny server. If using a large sample frame or if your design uses >2GB of memory, consider running the tool locally from your own workstation for faster processing. 
